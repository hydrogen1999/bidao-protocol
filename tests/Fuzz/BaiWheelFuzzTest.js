...
describe.skip('BaiWheelFuzzTest', () => {
  // This whole test is fake, but we're testing to see if our equations match reality.

  // First, we're going to build a simple simulator of the Bai protocol
  ...
  let runEvents = (globals, initState, events) => {
    ...
    return trueUpBai(globals, state);
  };
