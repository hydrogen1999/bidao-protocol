...
export interface XDAOScenarioMethods extends XDAOMethods {
...
export interface XDAO extends Contract {
  methods: XDAOMethods;
  name: string;
}

export interface XDAOScenario extends Contract {
  methods: XDAOScenarioMethods;
  name: string;
}
